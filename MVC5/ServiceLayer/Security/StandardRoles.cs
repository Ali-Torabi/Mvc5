        ...
        private static IEnumerable<PermissionRecord> GetDefaultRolesWithPermissions()
        {
            return new List<PermissionRecord>
            {
                ...
                new PermissionRecord
                {
                    ...
                    {
                        AssignableToRolePermissions.CanEditRolePermission,
                        AssignableToRolePermissions.CanDeleteRolePermission,
                        AssignableToRolePermissions.CanViewRolesListPermission,
                        AssignableToRolePermissions.CanCreateRolePermission,
                        AssignableToRolePermissions.CanSoftDeleteUserPermission,
                        AssignableToRolePermissions.CanViewUsersListPermission,
                        AssignableToRolePermissions.CanEditUsersSettingPermission,
                        AssignableToRolePermissions.CanAccessImagesPermission,
                        AssignableToRolePermissions.CanViewAdminPanelPermission,
